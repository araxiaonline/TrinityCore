...
namespace LuaWorldObject
{
    ...
    */
     ...
     */
    // DISABLED: GetElunaEvents not available
    /*
    ...
    */
     ...
     * </pre>
     */
    // DISABLED: lua_data member not available
    /*
    ...
    */
    ...
    ElunaRegister<WorldObject> WorldObjectMethods[] =
    {
        ...
        // { "RegisterEvent", &LuaWorldObject::RegisterEvent }, // DISABLED: GetElunaEvents not available
        // { "RemoveEventById", &LuaWorldObject::RemoveEventById }, // DISABLED: GetElunaEvents not available
        // { "RemoveEvents", &LuaWorldObject::RemoveEvents }, // DISABLED: GetElunaEvents not available
        ...
        // { "Data", &LuaWorldObject::Data } // DISABLED: lua_data member not available
    };
};
#endif
